...
def nytimes_comments(article):
    ...
    return total_comments #return the list back
...
article_url='http://www.nytimes.com/2013/04/03/world/arms-trade-treaty-approved-at-un.html'#  URL of the article you want to get

comments=nytimes_comments(article_url)
##commentnumber = 'Found '+str(total_comments)+' comments'
output = file('comments_printed.txt','a')
line = 'Found '+str(comments)+' comments' +'\n'
output.write(line)
output.close()
